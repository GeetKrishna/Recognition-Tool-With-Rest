...
<body  onload="noBack();"
	...
	<div class="container">
		<h2 align="center">Enter Nomination Details for Q3-Q4 Cycle 2015</h2>
		
		<h4 style="color: red">Please enter a valid name.</h4>
...
<input form="myForm" name="team" id="other_team" type="text" />
  ...
  <option value="no">No</option>
		...
		<div class="form-group">
			...
			<div class="radio">
				<label><input form="myForm" type="radio" name="corevalue"
					id="corevalue5" value="Relationship" />Relationship</label>
			</div>
			<div class="radio">
				<label> <input form="myForm" type="radio" name="corevalue"
